...
// const renderTable = () => {
  ...
  //   const $tr = $(`<tr><td>${index+1}</td><td>${member.id}</td><td>${member.pw}</td><td>${member.name}</td><td>${genderKr}</td><td>${member.tel}</td><td>${member.email}</td><td>${member.addr}</td><td>${member.birthday}</td><td>${}<td></tr>`);
